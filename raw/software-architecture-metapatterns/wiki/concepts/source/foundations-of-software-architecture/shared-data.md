...
![After a monolith is subdivided into services, a shared database is used to integrate the services.](/pixi-wiki/wiki/software-architecture-metapatterns/assets/images/Communication/Services%20to%20Shared%20Data.png)
...
![Both purchase and refund services see and edit the entire system's data.](/pixi-wiki/wiki/software-architecture-metapatterns/assets/images/Communication/Purchase%20and%20Return.png)
...
![Each service depends only on the shared database.](/pixi-wiki/wiki/software-architecture-metapatterns/assets/images/Communication/Shared%20Data%20-%20Dependencies.png)



![Adding a service to a system integrated through shared data does not require changes to other services.](/pixi-wiki/wiki/software-architecture-metapatterns/assets/images/Communication/Shared%20Data%20add%20a%20Service.png)
...
![A diagram of a ticketing service whose components use direct messaging to intercommunicate.](/pixi-wiki/wiki/software-architecture-metapatterns/assets/images/Communication/Notification%20to%20Notification.png)
...
![Stepwise processing of a batch of files.](/pixi-wiki/wiki/software-architecture-metapatterns/assets/images/Communication/Shared%20files.png)
...
![Components of the Blackboard Architecture.](/pixi-wiki/wiki/software-architecture-metapatterns/assets/images/Communication/Blackboard.png)
...
![Diagrams for: a queue per service, separate input and output queues, a queue per channel, and a single system queue.](/pixi-wiki/wiki/software-architecture-metapatterns/assets/images/Communication/Queues.png)
...
![A diagram of a ticketing service whose components rely on database notifications.](/pixi-wiki/wiki/software-architecture-metapatterns/assets/images/Communication/Notification%20inside%20the%20DB.png)
