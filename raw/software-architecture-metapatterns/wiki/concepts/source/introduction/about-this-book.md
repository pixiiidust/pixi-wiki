...
| \<\< [[wiki/concepts/source/introduction/introduction|Introduction]] | ^ [[wiki/concepts/source/introduction/introduction|Introduction]] ^ | [[wiki/concepts/source/introduction/metapatterns|Metapatterns]] \>\> |
| --- | --- | --- |
