...
| \<\< [Backends for Frontends \(BFF\)](<Backends for Frontends (BFF)>) | ^ [[wiki/concepts/source/fragmented-metapatterns/fragmented-metapatterns|Fragmented metapatterns]] ^ | [[wiki/concepts/source/fragmented-metapatterns/hierarchy|Hierarchy]] \>\> |
| --- | --- | --- |
