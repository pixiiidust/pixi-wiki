...
| \<\< [Service\-Oriented Architecture \(SOA\)](<Service-Oriented Architecture (SOA)>) | ^ [[wiki/concepts/source/fragmented-metapatterns/fragmented-metapatterns|Fragmented metapatterns]] ^ | [[wiki/concepts/source/implementation-metapatterns/implementation-metapatterns|Implementation metapatterns]] \>\> |
| --- | --- | --- |
