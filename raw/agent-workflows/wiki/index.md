...
# Agent Workflows — Master Index

> Compiled index for `agent-workflows`.
...
- [[concepts/discord-crew-onboarding|Discord Crew Onboarding Contract]] — Idempotent user allowlisting, direct-mention routing, inline bot-mention safety, bounded read-only retries, no duplicate side effects, one shared welcome thread, Pika/Pixoid fallback, and cross-host review branches.
