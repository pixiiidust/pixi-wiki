...
- [[concepts/agent-tooling-plan|Agent Tooling Plan]] — Agent-as-tools playbook for mapping vague or clear requests into task buckets, tools, routing rules, memory, evaluation, permissions, and feedback loops.
